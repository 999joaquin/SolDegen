...
import PlinkoChat from './PlinkoChat';
      ...
      <div className="bg-gray-900 p-6 rounded-2xl shadow-lg">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-white text-sm font-medium">{houseProfit.toFixed(2)} SOL</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gray-900 p-6 rounded-2xl shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white text-sm font-medium">{lastResult.payout.toFixed(2)} SOL</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white text-sm font-medium">{lastResult.balanceAfter.toFixed(2)} SOL</span>
            </div>
            <div className="flex justify-between">
            ...
            {betHistory.slice(-5).reverse().map((bet) => (
              <div key={bet.betId} className="flex justify-between items-center py-2 border-b border-gray-800 last:border-b-0">
                ...
                <div className="text-right">
                  <div className="text-white text-sm font-medium">{bet.payout.toFixed(2)} SOL</div>
